...
public class ReconstitutionFrame extends JFrame {
    ...
    protected static Logger LOGGER = LogManager.getLogger("VA_DICOM");
    ...
    public ReconstitutionFrame() {
        ...
        selectFiles.addMouseListener(new MouseAdapter() {
            public void mouseClicked(MouseEvent e) {
                ...
                //fileDialog.setFileFilter(new TGAFilter());
        ...
        shadowGroups.setBounds(203, 92, 186, 30);
        shadowGroups.setVisible(false);
