...
package com.sun.misc.treetable;
import javax.swing.*;
...
public class TreeTableExample2 {
    ...
    int count = treeTable.getColumnModel().getColumnCount();
    for(int i=0; i<count; i++){
        String columnName = treeTable.getColumnModel().getColumn(i).getHeaderValue().toString();
	...
	protected void generateChangeEvent(int row) {
        System.out.println("generateChangeEvent was invoked.");
	    if (row != -1) {
