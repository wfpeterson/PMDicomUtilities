...
public class DicomInstanceValidator {
	...
	private class OurURIResolver implements URIResolver {
		...
		System.out.println("OurURIResolver.resolve() href="+href+" base="+base);
	...
	public DicomInstanceValidator() throws javax.xml.transform.TransformerConfigurationException {
		System.out.println("Initializing DicomInstanceValidator...");
		String compiledXSLPath = "com/pixelmed/validate/";
		...
		System.out.println("System ID: "+transformSource.getSystemId());
		...
		System.out.println("DicomInstanceValidator Initialization completed...");
	}
