...
public class DicomConfigInfo {
    ...
    private boolean mUIDupdate = false;
    
    public DicomConfigInfo(){
    }
    
    public DicomConfigInfo(String _Alias, String _AE, String _CallingAE, String _Role, String _Host, String _Port){
        mAlias = _Alias;
    ...
    public DicomConfigInfo(DicomConfigInfo info){
        ...
        mHost = info.getHost();
        mPort = info.getPort(); 
        mUIDupdate = info.ismUIDupdate();
    }
    public void Copy(DicomConfigInfo info){
        /**
    ...
    public boolean contentEquals(DicomConfigInfo that){
    ...
    /**
     * @return the mUIDupdate
     */
    public boolean ismUIDupdate() {
        return mUIDupdate;
    }

    /**
     * @param mUIDupdate the mUIDupdate to set
     */
    public void setmUIDupdate(boolean mUIDupdate) {
        this.mUIDupdate = mUIDupdate;
    }
}